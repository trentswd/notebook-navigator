> [!IMPORTANT]
> **Unofficial three-column fork.** This fork was updated by
> [trentswd](https://github.com/trentswd) on 2026-08-11 from Notebook Navigator
> 3.3.3. It is not supported by the upstream author.
>
...
> available in the [`codex/three-column-3.3.3`](https://github.com/trentswd/notebook-navigator/tree/codex/three-column-3.3.3)
> branch.
